...
[(#9061)](http://bugs.jqueryui.com/ticket/9061) .zIndex() is now deprecated in favor of the new .ui-front/appendTo logic.

[todo: link to docs about .ui-front]
...
Previously, the puff, size and scale effects all shared a single file. We've cleaned that up and move both puff and size into their own files.
